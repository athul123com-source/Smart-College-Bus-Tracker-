              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Welcome, ${authProvider.currentUser?.name ?? 'Parent'}',
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          'Select your child\'s bus to track',
                          style: Theme.of(context)
                              .textTheme
                              .bodySmall
              ...
              children: [
                _buildActionButton(
                  ...
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => _ParentChildrenScreen(
                            parentEmail: authProvider.currentUser?.email),
                      ),
                    );
                  },
                ),
...
class _ParentChildrenScreen extends StatelessWidget {
  final String? parentEmail;

  const _ParentChildrenScreen({required this.parentEmail});
  ...
  Widget build(BuildContext context) {
    if (parentEmail == null || parentEmail!.isEmpty) {
      return Scaffold(
        ...
        body: const Center(
          child: Text('No parent email found for this account.'),
        ),
      );
    }
